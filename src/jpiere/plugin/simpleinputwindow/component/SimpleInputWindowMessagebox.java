...
public class SimpleInputWindowMessagebox extends Window implements EventListener<Event>
{
	/**
	 *
	 */
	...
	public SimpleInputWindowMessagebox()
	{
		super();
	}
	...
	{
		return show(message, title, buttons, icon, callback, false, null);
	}
