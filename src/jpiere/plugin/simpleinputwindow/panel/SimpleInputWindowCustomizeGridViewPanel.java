 ...
 *
 */
public class SimpleInputWindowCustomizeGridViewPanel extends Panel
{
	/**
	 *
	 */
...
/**
	...
	public void loadData()
	{
		...
		try
		{
			...
			HashMap<Integer, ListElement> curTabSel = new HashMap<Integer, SimpleInputWindowCustomizeGridViewPanel.ListElement>();
...
//		if (m_tabcust != null && m_tabcust.getCustom().indexOf("px") > 0)
	...
	public void saveData()
	{
		...
		if(ok) {
			...
			if(gridPanel!=null){
				try {
					gridPanel.onEvent(new Event("onCustomizeGrid"));
				} catch (Exception e) {
					;
				}
			}
